...
const zhCN = {
  ...
  init: {
    ...
    workflows: {
      dev: '完整开发工作流 (/cogem:workflow)',
      frontend: '前端任务 (/cogem:frontend)',
      backend: '后端任务 (/cogem:backend)',
      review: '代码审查 (/cogem:review)',
      analyze: '技术分析 (/cogem:analyze)',
      commit: 'Git 智能提交 (/cogem:commit)',
      rollback: 'Git 回滚 (/cogem:rollback)',
      cleanBranches: '清理分支 (/cogem:clean-branches)',
      worktree: 'Worktree 管理 (/cogem:worktree)',
      init: '项目初始化 (/cogem:init)',
    },
    aceTool: {
  ...
  menu: {
    ...
    help: {
      title: 'CoGem 命令:',
      hint: '更多信息请运行: npx cogem-dualflow --help',
      descriptions: {
        dev: '完整六阶段开发工作流',
    ...
    uninstall: {
      confirm: '确定要卸载 CoGem 吗？这将强制移除所有命令目录、配置文件和数据。',
...
const en = {
  ...
  cli: {
    help: {
      ...
      commandDescriptions: {
        ...
        initConfig: 'Initialize CoGem multi-model collaboration system',
      },
      shortcuts: 'Shortcuts:',
      shortcutDescriptions: {
  ...
  init: {
    welcome: 'Welcome to CoGem Multi-Model Collaboration System',
    ...
    workflows: {
      dev: 'Full development workflow (/cogem:workflow)',
      frontend: 'Frontend tasks (/cogem:frontend)',
      backend: 'Backend tasks (/cogem:backend)',
      review: 'Code review (/cogem:review)',
      analyze: 'Technical analysis (/cogem:analyze)',
      commit: 'Git smart commit (/cogem:commit)',
      rollback: 'Git rollback (/cogem:rollback)',
      cleanBranches: 'Clean branches (/cogem:clean-branches)',
      worktree: 'Worktree management (/cogem:worktree)',
      init: 'Project initialization (/cogem:init)',
    },
    aceTool: {
  ...
  menu: {
    title: 'CoGem Main Menu',
    options: {
      init: 'Initialize CoGem configuration',
      update: 'Update workflows',
      uninstall: 'Uninstall CoGem',
      help: 'Help',
      exit: 'Exit',
    },
    help: {
      title: 'CoGem Commands:',
      hint: 'For more information, run: npx cogem-dualflow --help',
      descriptions: {
    ...
    uninstall: {
      confirm: 'Are you sure you want to uninstall CoGem? This will force remove all command directories, config files and data.',
