...
6. **Decision Gate**
   - **If Critical > 0**:
     ...
     * Ask: "Fix now or return to `/cogem:spec-impl` to address?"
...
8. **Context Checkpoint**
   ...
   - If approaching 80K tokens, suggest: "Run `/clear` and continue with `/cogem:spec-review` or `/cogem:spec-impl`"
...
- Archive (after passing): `/cogem:spec-impl` → Step 10
<!-- CoGem:SPEC:REVIEW:END -->
